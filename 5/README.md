...
**ВНИМАНИЕ!** Для программ Matrikon OPC Explorer, Matrikon OPC HDA Explorer необходимо пройти процедуру регистрации на сайте [MatrikonOPC](https://matrikonopc.com/) 
